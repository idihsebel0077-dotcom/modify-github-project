...
export default function UtilityBar() {
  return (
    <div className="w-full bg-black text-white h-10 flex items-center justify-end px-4 md:px-10">
      <span className="text-base font-semibold mr-4 md:mr-10">Follow:</span>
